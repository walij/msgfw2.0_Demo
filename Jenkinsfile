pipeline {  
	...
	//step([$class: 'XrayImportBuilder', endpointName: '/junit', fixVersion: 'walij', importFilePath: 'C:\\Program Files (x86)\\Jenkins\\workspace\\msgfw2.0\\Testresults\\Results.xml', importToSameExecution: 'true', projectKey: 'XJ', serverInstance: 'CLOUD-3f0b34ae-2880-4013-9571-41ed5f13027f', testExecKey: 'XJ-5', testPlanKey: 'XJ-4'])
	step([$class: 'XrayImportBuilder', endpointName: '/xunit', importFilePath: 'C:\\Program Files (x86)\\Jenkins\\workspace\\msgfw2.0\\Testresults\\Results.xml', importToSameExecution: 'true', projectKey: 'XJ', serverInstance: 'CLOUD-3f0b34ae-2880-4013-9571-41ed5f13027f', testExecKey: 'XJ-5', testPlanKey: 'XJ-4'])
	}
    }
